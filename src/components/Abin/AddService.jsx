...
const AddServiceForm = ({ onSubmit, onCancel }) => {
  // Controlled form states matching all fields from image_4983bc.png
  ...
  return (
    /* FIXED: Changed 'max-w-3xl' to 'max-w-none' so it matches the structural parent size */
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full text-sm px-3 py-2 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-emerald-500 placeholder-slate-300 text-slate-700"
              required
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full text-sm px-3 py-2 border border-slate-200 rounded-md bg-white focus:outline-none focus:ring-1 focus:ring-emerald-500 text-slate-700"
            >
        ...
        <div className="space-y-1">
          ...
          <textarea
            ...
            rows={3}
            className="w-full text-sm px-3 py-2 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-emerald-500 placeholder-slate-300 text-slate-700 resize-none"
          />
        </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="6,999"
                className="w-full text-sm pl-7 pr-3 py-2 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-emerald-500 placeholder-slate-300 text-slate-700"
                required
              />
            </div>
          </div>
